...
<div class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="verifyModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifyModalLabel">Kembalikan Laporan</h5>
            ...
            <form action="<?= Routes::base('dataLaporan/status') ?>" method="post">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="status" value="Menunggu tanggapan">
                    <p>Apakah anda ingin mengembalikan laporan? </p>
