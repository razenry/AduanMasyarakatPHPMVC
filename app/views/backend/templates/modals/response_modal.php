...
<div class="modal fade" id="responseModal" tabindex="-1" aria-labelledby="verifyModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifyModalLabel">Tuntaskan Laporan</h5>
            ...
            <form action="<?= Routes::base('dataLaporan/status') ?>" method="post">
                <div class="modal-body">
                    ...
                    <p>Apakah laporan ini sudah di kerjakan? </p>
